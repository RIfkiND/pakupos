...
public class POSView implements View {
    ...
    @FXML private Label cashGrandTotalLabel;
    @FXML private TextField cashInputField;
    @FXML private Label changeLabel;
    
    @FXML private Label qrisGrandTotalLabel;
    ...
    private void renderProducts() {
        ...
        for (ProductResponseDTO p : model.getCatalog()) {
            ...
            card.getStyleClass().addAll("product-list-card");
            ...
            Label badgeLabel = new Label("Tersedia");
            badgeLabel.getStyleClass().addAll("badge");
    ...
    private void updateCartSummary() {
        if (itemCountLabel == null || totalPriceLabel == null) return;
    ...
    private void updateReceipt() {
        if (receiptItemsBox == null) return;
        ...
        if (subtotalLabel != null) subtotalLabel.setText(com.aulkhami.pakupos.app.utils.CurrencyHelper.formatRupiah(subtotal));
        if (taxLabel != null) taxLabel.setText(com.aulkhami.pakupos.app.utils.CurrencyHelper.formatRupiah(tax));
        if (grandTotalLabel != null) grandTotalLabel.setText(com.aulkhami.pakupos.app.utils.CurrencyHelper.formatRupiah(currentGrandTotal));
        if (cashGrandTotalLabel != null) cashGrandTotalLabel.setText(com.aulkhami.pakupos.app.utils.CurrencyHelper.formatRupiah(currentGrandTotal));
        if (qrisGrandTotalLabel != null) qrisGrandTotalLabel.setText(com.aulkhami.pakupos.app.utils.CurrencyHelper.formatRupiah(currentGrandTotal));
    }
    ...
    private void calculateChange() {
        if (cashInputField == null || changeLabel == null) return;
        try {
